...
public class VisitorsApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(VisitorsApp.class);

    private final Environment env;

    public VisitorsApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(VisitorsApp.class);
