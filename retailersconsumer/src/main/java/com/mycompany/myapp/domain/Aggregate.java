...
public class Aggregate implements Serializable {
    ...
    public Aggregate transaction(RetailersTransactions transaction) {
        this.aggregateId = String.valueOf(transaction.hashCode());
        this.type=RetailersTransactions.class.toString();
        this.data=transaction.getUuid();
        return this;
    }
