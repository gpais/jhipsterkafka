...
public class RetailersApp {

    private static final Logger log = LoggerFactory.getLogger(RetailersApp.class);

    private final Environment env;

    public RetailersApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes retailers.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RetailersApp.class);
