...
public class TransactionsenderApp {

    private static final Logger log = LoggerFactory.getLogger(TransactionsenderApp.class);

    private final Environment env;

    public TransactionsenderApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes transactionsender.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TransactionsenderApp.class);
